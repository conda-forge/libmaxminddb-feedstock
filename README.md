...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libmaxminddb-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libmaxminddb-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libmaxminddb
# for installing globally
pixi global install libmaxminddb
```
...
It is possible to list all of the versions of `libmaxminddb` available on your platform:
...
```
pixi search libmaxminddb --channel conda-forge
```
